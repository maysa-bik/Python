...
class Grille:
    def __init__(self):
        self.board_surface = pygame.Surface((ROWS * TILESIZE, COLS * TILESIZE))
        self.board_list = [[Case(col, row, tile_empty, ".") for row in range(ROWS)] for col in range(COLS)]
        self.place_mines()
        self.place_clues()
        self.dug = []
